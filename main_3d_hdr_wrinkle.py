...
if __name__=="__main__":
    ...
    parser.add_argument("--gpu_id", required=False, default=1, help="path to the yaml config file")
    ...
    parser.add_argument("--resume_checkpoint", 
                        default="/hdd1/leedoright/workspace/gaussian_avatar/output/track_256/226/final_gt_normal/train/checkpoint/ckpt_010000.pt")
