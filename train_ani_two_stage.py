...
def main(args):
    ...
    for iteration in range(start_iter, full_iterations + 1):
        ...
        if iteration==1 or iteration % 1000 == 0:
            ...
            if iteration > 60000:
                uv_color = torch.cat([head_model.canon_color, feat_uv_dict['features_dc_logit']], dim=-1)
                save_image(uv_color, f'{output_path}/uv_color_{iteration:06d}.png')
...
if __name__=="__main__":
    ...
    parser.add_argument("--version", default="two_stage")
