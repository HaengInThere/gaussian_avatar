...
try:
    ...
    parent_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                              "r3dg-rasterization")
    parent_dir = "/hdd1/leedoright/workspace/Relightable3DGaussian/r3dg-rasterization"

    # # PBR
    # root_dir = '/hdd1/leedoright/workspace/relight_face/GS-IR'
    # # CUDA rasterizer lives in submodules/diff-gaussian-rasterization
    # parent_dir = os.path.join(root_dir, "submodules", "diff-gaussian-rasterization")

    # project root: .../relight_face
